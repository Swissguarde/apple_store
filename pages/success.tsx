...
const Success = ({ products }: Props) => {
  ...
  const _price = subTotal + 20;
  const price = new Intl.NumberFormat().format(_price);
  useEffect(() => {
    setMounted(true);
  }, []);
            ...
            >
              <div className="mx-auto flex max-w-xl items-center justify-between px-4 py-6">
                ...
                <p className="text-xl font-medium text-black">
                  {/* <Currency quantity={subtotal + 20} /> */}£{subTotal}
                </p>
              </div>
            </div>
                ...
                <div className="space-y-1 py-4">
                  <div className="flex justify-between text-sm">
                    ...
                    <p className="font-medium">
                      {/* <Currency quantity={subtotal} /> */}£{subTotal}
                    </p>
                  </div>
                  <div className="flex justify-between text-sm">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <p className="font-medium">
                      {/* <Currency quantity={20} currency="USD" /> */} £20
                    </p>
                  </div>
                </div>
                <div className="flex justify-between pt-4">
                  ...
                  <p className="flex items-center gap-x-2 text-xs text-[gray]">
                    ...
                    <span className="text-xl font-medium text-black">
                      {/* <Currency quantity={subtotal + 20} /> */}£{price}
                    </span>
                  </p>
                </div>
              </div>
