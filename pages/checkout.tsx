...
const Checkout = () => {
  ...
  useEffect(() => {
    ...
    setGroupBasketItems(groupedItems);
  }, [items]);
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[#E7ECEE] transition-all duration-300">
      <Head>
            ...
            <div className="my-12 mt-6 ml-auto max-w-3xl">
              <div className="divide-y divide-gray-300">
                <div className="pb-4">
                  ...
                  <div className="flex justify-between">
                    <div className="flec-col flex gap-x-1 lg:flex-row">
                      Estimated tax for:{" "}
